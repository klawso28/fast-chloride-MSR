set title "MCFR radius 200.0, height 450.0, reflector_t 50.0" 
%______________surface definitions__________________________________
surf 1  cylz  0.0 0.0 200.0      % fuel salt
surf 2  cylz  0.0 0.0 250.0      % radial reflector
...
set pop 100000 240 40 
set power 1800000000.0  % 1.8 thermal GW
set bc 1  % vacuum 

ene six_group 1 1E-11 7.485E-4 5.5308E-3 2.47875E-2 0.4979 2.2313 12
set gcu re fs  % group constant generation in fs and re
set nfg six_group
set micro nj20
